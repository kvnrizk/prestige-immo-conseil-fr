...
const HeroSection = () => {
  ...
  return (
    <section id="accueil" className="min-h-screen flex items-center bg-gradient-to-br from-gray-50 to-white pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Votre projet
                <span className="text-amber-600 block">immobilier</span>
            ...
            <div className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                  <span className="text-gray-700">Expertise locale</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                  <span className="text-gray-700">Disponibilité 7j/7</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  ...
                  className="border-amber-600 text-amber-600 hover:bg-amber-50 px-8 py-3 text-lg font-medium"
                >
                  Voir les biens
                </Button>
              </div>
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-amber-100 to-amber-50 rounded-2xl p-8 shadow-xl">
              <img
