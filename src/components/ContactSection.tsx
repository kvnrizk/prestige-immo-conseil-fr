              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@immobilierpro.fr</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">Zone d'intervention</h4>
                    <p className="text-gray-600">Lyon et métropole</p>
                    <p className="text-sm text-gray-500">Déplacements possibles en Rhône-Alpes</p>
                  </div>
                </div>
              </div>
            </div>
